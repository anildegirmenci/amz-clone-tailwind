    ...
    cartItems.forEach(item => {
        itemsHTML += `
            <div class="cart-item flex items-center pb-4 border-b border-gray-200">
                <div class="cart-item-image w-44 p-4 bg-white rounded-lg h-24">
                    <img src="${item.image}"
                        alt="">
                </div>
                <div class="cart-item-details font-semibold flex-grow">
                ...
                <div class="cart-item-counter w-48 flex items-center">
                    <div data-id="${item.id}" class="cart-item-decrease cursor-pointer text-gray-400 bg-gray-100 rounded 
                    w-6 h-6 flex justify-center items-center hover:bg-gray-200 
                    mr-2">
                        <i class="fas fa-chevron-left fa-xs"></i>
                    </div>
                    <h4 class="text-gray-400">x${item.quantity}</h4>
                    <div data-id="${item.id}" class="cart-item-increase cursor-pointer text-gray-400 bg-gray-100 rounded
                    w-6 h-6 flex justify-center items-center hover:bg-gray-200 
                    ml-2">
